...
A system of two linear equations can be solved by substitution or elimination. In the substitution method, one variable is isolated from one equation and inserted into the other equation. This reduces the system to a single equation in one unknown.
